...
class CardAdapter(
    ...
    class CardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: CardItem, lock: Boolean, onToggle: () -> Unit) {
            ...
            // Usamos iconos diferentes para indicar el estado de favorito
            favButton.setIconResource(if (item.isFavorite) android.R.drawable.btn_star_big_on else android.R.drawable.btn_star_big_off)
