...
import com.example.p2dam_226.viewmodels.ListViewModelFactory
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener { item ->
            return@setNavigationItemSelectedListener when (item.itemId) {
                R.id.action_logout -> {
                    com.example.p2dam_226.firebase.FirebaseProvider.provideAuth().signOut()
        ...
        listViewModel = ViewModelProvider(this, com.example.p2dam_226.viewmodels.ListViewModelFactory())[ListViewModel::class.java]
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            ...
            if (!inAuth) {
                ...
                val user = com.example.p2dam_226.firebase.FirebaseProvider.provideAuth().currentUser
